...
export const FETCH_IN_THEATRES=`https://api.themoviedb.org/3/movie/now_playing?api_key=${process.env.NEXT_PUBLIC_API_KEY}&language=en-US&page=1&region=us`

export const FETCH_MOVIE_INFO=``
